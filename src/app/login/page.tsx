    ...
    return (
        <div className="flex flex-col h-screen items-center p-12 overflow-hidden">
            ...
            <div className="flex h-screen w-full items-center justify-center bg-cover bg-center ">
                <div className="mx-4 flex max-w-md flex-col items-center justify-center rounded-lg p-8 md:mx-0 outline outline-offset-8 outline-orange-logo">
                    <div className="mb-8 flex w-full flex-col items-center justify-center relative">
                        ...
                        <h1 className="text-6xl font-road-rage text-orange-logo text-center text-pretty">Bem vindo a Dom Chico</h1>
